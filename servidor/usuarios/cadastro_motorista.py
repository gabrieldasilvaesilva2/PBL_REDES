...
DIRETORIO_USUARIOS = os.path.join(DIRETORIO_ATUAL, "jsons_motoristas") # define o caminho pra pasta jsons dos usuarios
...
def cadastrar_motorista(nome, email, senha,carro,cor_carro):
  ...
  dados_usuario = {
    "perfil": {"nome": nome,"email": email,"senha": senha,"carro":carro,"cor_carro":cor_carro},
    "historico_corridas":[],"coridas_ativas":[]
  }
